...
private:
    ...
    void ParseAllShopInfo(const int cmd_type, const QJsonObject &obj);
    void ParseCommodityForShop(const int cmd_type, const QJsonObject &obj);
    void ParseGetRepertoryLocal(const int cmd_type, const QJsonObject &obj);
    void ParseGetRepertoryShip(const int cmd_type, const QJsonObject &obj);
    void ParseGetCommodityForID(const int cmd_type, const QJsonObject &obj);
    void ParseUpdateShipment(const int cmd_type, const QJsonObject &obj);
    void ParseInsertShop(const int cmd_type, const QJsonObject &obj);
