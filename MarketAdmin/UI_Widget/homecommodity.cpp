    ...
    ui(new Ui::HomeCommodity)
{
    ...
    ui->pb_add->setIcon(QPixmap(":/ico/insert.png"));
...
void HomeCommodity::SlotAllCommodity(int number)
{
    ...
    ui->le_sid->setText(obj.value("goods_id").toString());
    ui->le_name->setText(obj.value("goods_name").toString());
    ui->le_old_price->setText(obj.value("goods_old_price").toString());
    ui->le_new_price->setText(obj.value("goods_new_price").toString());
...
void HomeCommodity::on_pb_setinfo_clicked()
{
    ui->le_name->setEnabled(true);
    ui->le_new_price->setEnabled(true);
    ui->le_old_price->setEnabled(true);
}

void HomeCommodity::on_pb_cancel_clicked()
{
    ui->le_name->setEnabled(false);
    ui->le_new_price->setEnabled(false);
    ui->le_old_price->setEnabled(false);
}
